...
export const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#0E0B16] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/59a985ed-6980-48d9-bba3-0b6f7b4270e0" className='flex flex-col max-w-[600px] w-full'>
            <div className='pt-20'>
                <p className='text-4xl font-bold inline border-b-4 border-[#A238Ca] text-gray-300'>Contact</p>
            ...
            <button className='text-white border-2 hover:bg-[#A238Ca] hover:border-[#A238Ca] px-4 py-3 my-8 mx-auto flex items-center'>Let's Collaborate</button>
        </form>
